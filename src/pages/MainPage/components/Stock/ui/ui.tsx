        ...
        <div className={c.container}>
            ...
            <div className={c.grid}>
                ...
                <div className={[c.elem1, c.elem].join(' ')}>
                    <img src="/gender.svg" className={c.icon} />
                    ...
                    <div className={c.info}>
                        ...
                        <span className={c.desc}>«Боль в спине<br/>Расширенный»</span>
                    </div>
                </div>

                <div className={[c.elem2, c.elem].join(' ')}>
                    <img src="/boy-gender.svg" className={c.icon} />
                ...
                <div className={[c.elem3, c.elem].join(' ')}>
                    <img src="/girl-gender.svg" className={c.icon} />
                ...
                <div className={[c.elem4, c.elem].join(' ')}>
                    <img src="/gender-gray.svg" className={c.icon} />
