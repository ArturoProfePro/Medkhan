        ...
        <div className={c.container}>
            ...
            <div className={c.list}>
                <div className={c.elem}>
                    ...
                    <span className={c.title}>Нудельман <br />Наталия Федоровна</span>
                ...
                <div className={c.elem}>
                    ...
                    <span className={c.title}>Хан<br />Умар Хаят</span>
                ...
                <div className={c.elem}>
                    ...
                    <span className={c.title}>Хан<br />Тюльпан Тимергалиевна </span>

                    <span className={c.desc}>Акушер-гинеколог, врач УЗИ,<br />генеральный директор, гинеколог</span>
                ...
                <div className={c.elem}>
                    ...
                    <span className={c.title}>Башарова<br />Альбина Шарипзяновна </span>

                    <span className={c.desc}>Терапевт, главный специалист<br />в сфере медицины</span>
